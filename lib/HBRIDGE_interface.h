...
#define HBRIDGE_LEFT_PORT DIO_PORTA
#define HBRIDGE_LEFT_PIN DIO_PIN0

#define HBRIDGE_RIGHT_PORT DIO_PORTA

#define HBRIDGE_RIGHT_PIN0 DIO_PIN0
#define HBRIDGE_RIGHT_PIN1 DIO_PIN1
#define HBRIDGE_LEFT_PIN0 DIO_PIN2
#define HBRIDGE_LEFT_PIN1 DIO_PIN3
